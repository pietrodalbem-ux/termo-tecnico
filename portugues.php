...
<head>
    ...
    <title>Português - Dicionário de termos</title>
...
<body class="bg-body">
    ...
    <div class="d-md-none bg-dark border-bottom border-primary p-3 d-flex justify-content-between align-items-center shadow-sm sticky-top">
        <div>
            <span class="fw-bolder text-primary fs-4 tracking-tight">Dicionário </span>
        ...
        <div class="row">
            ...
            <nav class="col-md-3 col-lg-2 offcanvas-md offcanvas-start bg-dark border-end border-primary border-4 position-fixed vh-100 p-3 d-flex flex-column shadow-lg" id="menuLateral">
                <div class="offcanvas-header d-md-none mb-0 pb-0">
                    <h5 class="offcanvas-title fw-bolder text-primary">Dicionário <span class="text-secondary fs-6">de termos</span></h5>
                ...
                <div class="text-center mb-4 mt-3 d-none d-md-block">
                    <h2 class="fw-bolder text-primary tracking-tight mb-0">Dicionário </h2>
                ...
                <ul class="nav nav-pills flex-column mb-auto mt-4 mt-md-0">
                    ...
                    <li class="nav-item">
                        <a href="portugues.php" class="nav-link active bg-primary text-white mb-2 fw-bold" aria-current="page">
                            <i class="bi bi-book me-2"></i> Português
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="matematica.php" class="nav-link text-white mb-2">
                            <i class="bi bi-calculator me-2"></i> Matemática
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="postar_termo.php" class="nav-link text-white mb-2">
                            <i class="bi bi-bookmark-plus me-2"></i> Adicionar Termo
                        </a>
                    </li>
            ...
            <main class="col-md-9 offset-md-3 col-lg-10 offset-lg-2 px-3 px-md-5 py-4 py-md-5 min-vh-100 position-relative">
                ...
                <div class="mb-5 border-bottom border-primary pb-3">
                    <h1 class="fw-bold text-primary"><i class="bi bi-book"></i> Português</h1>
    ...
    <script>
        ...
        function gerarCartao(termo, carrossel = false) {
            let iconeAutor = termo.autor.toLowerCase() === 'professor' 
                ...
                : (carrossel ? '<span class="badge bg-info mb-2 text-dark"><i class="bi bi-fire"></i> Novo</span>' : '<span class="badge bg-primary mb-2 text-white"><i class="bi bi-person"></i> Aluno</span>');
