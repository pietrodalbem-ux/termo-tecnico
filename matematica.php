...
<head>
    ...
    <title>Matemática - Dicionário de termos</title>
...
<body class="bg-body">
    ...
    <div class="d-md-none bg-dark border-bottom border-danger p-3 d-flex justify-content-between align-items-center shadow-sm sticky-top">
        <div>
            <span class="fw-bolder text-danger fs-4 tracking-tight">Dicionário </span>
        ...
        <div class="row">
            ...
            <nav class="col-md-3 col-lg-2 offcanvas-md offcanvas-start bg-dark border-end border-danger border-4 position-fixed vh-100 p-3 d-flex flex-column shadow-lg" id="menuLateral">
                <div class="offcanvas-header d-md-none mb-0 pb-0">
                    <h5 class="offcanvas-title fw-bolder text-danger">Dicionário <span class="text-secondary fs-6">de termos</span></h5>
                ...
                <div class="text-center mb-4 mt-3 d-none d-md-block">
                    <h2 class="fw-bolder text-danger tracking-tight mb-0">Dicionário </h2>
                ...
                <ul class="nav nav-pills flex-column mb-auto mt-4 mt-md-0">
                    ...
                    <li class="nav-item">
                        <a href="portugues.php" class="nav-link text-white mb-2">
                            <i class="bi bi-book me-2"></i> Português
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="matematica.php" class="nav-link active bg-danger text-white mb-2 fw-bold" aria-current="page">
